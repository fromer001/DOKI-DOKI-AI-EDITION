    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("New Game"):
                ...
                activate_sound "audio/sfx/select_glitch.ogg"
                action Start() 
        ...
        textbutton _("Load Game"):
            ...
            action Show("custom_save_screen")
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i, folder in enumerate(chats):
                    ...
                    button:
                        ...
                        action [SetVariable("num", i), FileActionMod(slot), Start()]

                        has vbox

                        add FileScreenshot(slot) xalign 0.5

                        text FileTime(slot, format=_(f"{chat_list[i]}"), empty=_("empty slot")):
...
screen gamemode_screen():
    ...
    imagebutton:
        ...
        xpos 0.37
        ypos 0.40
        idle "gui/gamemode/unselected_m.png"
        hover "gui/gamemode/selected_m.png"

        hover_sound "audio/sfx/hover.wav"
        activate_sound "audio/sfx/select_sfx.wav"
        action [Hide("gamemode_screen"), Jump("nameWorld_label")]

        hovered Show("display_monika_desc")
        unhovered Hide("display_monika_desc")
        
    on "hide" action Hide("display_monika_desc")
    ...
    imagebutton:
        ...
        xpos 0.80
        ypos 0.40
        idle "gui/gamemode/unselected_e.png"
        hover "gui/gamemode/selected_e.png"
    ...
    on "hide" action Hide("display_everyone_desc")
